...
const imageUploadSchema = z.object({
  ...
  GarageSqFt: z.coerce
    .number()
    .min(0, "Garage Square Footage must be at least 0"),
  BasementSqFt: z.coerce
    .number()
    .min(0, "Basement Square Footage must be at least 0"),
  ...
  return (
    <>
      ...
      >
        ...
        {/* Property Details */}
        <div>
          <label htmlFor="propdetails" className="block font-semibold mb-1">
            {" "}
        ...
        {/* Square Footage */}
        <div>
          <label htmlFor="sqft" className="block font-semibold mb-1">
            Square Footage (m²)
          </label>
          <input
            id="sqft"
        ...
        <div>
          ...
          />
          {errors.LotSize && (
            <span className="text-red-500">{errors.LotSize.message}</span>
          )}
        </div>
        ...
        {/* HOA Dues */}
        <div>
          <label htmlFor="HOADues" className="block font-semibold mb-1">
            HOA Dues
          </label>
          <input
            id="HOADues"
          ...
          />
          {errors.HOADues && (
            <span className="text-red-500">{errors.HOADues.message}</span>
          )}
        </div>
        ...
        {/* Garage m² */}
        <div>
          <label htmlFor="GarageSqFt" className="block font-semibold mb-1">
          ...
          <input
            ...
            {...register("GarageSqFt")}
            onChange={(e) =>
              setValue("GarageSqFt", Number(e.target.value) || 0)
            }
            className="w-full border rounded p-2"
          />
          {errors.GarageSqFt && (
            <span className="text-red-500">{errors.GarageSqFt.message}</span>
          )}
        </div>

        {/* Basement m² */}
        <div>
          <label htmlFor="BasementSqFt" className="block font-semibold mb-1">
          ...
          <input
            ...
            onChange={(e) =>
              setValue("BasementSqFt", Number(e.target.value) || 0)
            }
            className="w-full border rounded p-2"
          />
          {errors.BasementSqFt && (
            <span className="text-red-500">{errors.BasementSqFt.message}</span>
          )}
        </div>

        {/* Property Type */}
        <div>
          <label htmlFor="propertyType" className="block font-semibold mb-1">
            Property Type
          </label>
          <select
            id="propertyType"
